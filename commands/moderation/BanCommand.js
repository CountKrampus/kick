...
if (!mentionedMember.bannable) return message.channel.send ('I cannot ban a member with the same perms as you!');

//execute:
 const banEmbed = new Discord.MessageEmbed()
   .setTitle(`You have been banned from ${message.guild.named}`)
